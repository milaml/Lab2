/* package mk.finki.ukim.mk.wp1.web;
...
@WebServlet(name = "movies", urlPatterns = "/mo")
public class MovieServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(title!=null && !title.isEmpty() && numOfTickets>0){
            resp.sendRedirect("/ticketOrder?title=" + title + "&numOfTickets=" + numOfTickets);
        }
